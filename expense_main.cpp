...
void display(char jk){
	...
	string date[100],d;
	int a,j,i =0;
	double sum =0,total=0,bal=0,sum2=0;
	...
	cout<<"-----------------------------------"<<endl;
	if(jk == 'E' || jk == 'e')	
		cout<<"Total:"<<total<<"  Expense:"<<sum<<" Balance: "<<(total-sum)<<endl;
	else if(jk == 'I' || jk == 'i')	
		cout<<"Total:E"<<(total+sum)<<"  Expense:"<<total<<" Balance: "<<sum<<endl;
	else if(jk == 'A' || jk == 'a')	
		cout<<"Total:"<<(sum)<<"  Expense:"<<sum2<<" Balance: "<<(sum-sum2)<<endl;
	hello();
